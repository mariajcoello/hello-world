...
.method public constructor <init>(Landroid/view/ViewGroup;Landroid/content/Context;Lcom/google/android/gms/maps/GoogleMapOptions;)V
    ...
    iput-object v0, p0, Lbie;->e:Ljava/util/List;

    iput-object p1, p0, Lbie;->b:Landroid/view/ViewGroup;

    iput-object p2, p0, Lbie;->c:Landroid/content/Context;

    iput-object p3, p0, Lbie;->d:Lcom/google/android/gms/maps/GoogleMapOptions;
...
.method public a()V
    ...
    iget-object v0, p0, Lbie;->a:Lcom/google/android/gms/dynamic/f;

    if-eqz v0, :cond_1

    invoke-virtual {p0}, Lbie;->je()Lcom/google/android/gms/dynamic/LifecycleDelegate;
    ...
    :try_start_0
    iget-object v0, p0, Lbie;->c:Landroid/content/Context;
    ...
    iget-object v1, p0, Lbie;->c:Landroid/content/Context;

    invoke-static {v1}, Lcom/google/android/gms/dynamic/e;->k(Ljava/lang/Object;)Lcom/google/android/gms/dynamic/d;

    move-result-object v1

    iget-object v2, p0, Lbie;->d:Lcom/google/android/gms/maps/GoogleMapOptions;
    ...
    iget-object v1, p0, Lbie;->a:Lcom/google/android/gms/dynamic/f;

    new-instance v2, Lbic;

    iget-object v3, p0, Lbie;->b:Landroid/view/ViewGroup;

    invoke-direct {v2, v3, v0}, Lbic;-><init>(Landroid/view/ViewGroup;Lcom/google/android/gms/maps/internal/IMapViewDelegate;)V

    invoke-interface {v1, v2}, Lcom/google/android/gms/dynamic/f;->a(Lcom/google/android/gms/dynamic/LifecycleDelegate;)V

    iget-object v0, p0, Lbie;->e:Ljava/util/List;
    ...
    invoke-virtual {v1, v0}, Lbic;->getMapAsync(Lcom/google/android/gms/maps/OnMapReadyCallback;)V
    :try_end_0
...
.method protected a(Lcom/google/android/gms/dynamic/f;)V
    ...
    iput-object p1, p0, Lbie;->a:Lcom/google/android/gms/dynamic/f;
...
.method public a(Lcom/google/android/gms/maps/OnMapReadyCallback;)V
    ...
    invoke-virtual {v0, p1}, Lbic;->getMapAsync(Lcom/google/android/gms/maps/OnMapReadyCallback;)V
