...
.method constructor <init>(Lbmv;Landroid/content/Context;)V
    .locals 2
    ...
    invoke-direct {p0, p1, p2, v0, v1}, Lbof;-><init>(Lbmv;Landroid/content/Context;Ljava/lang/String;I)V

    return-void
.end method

.method constructor <init>(Lbmv;Landroid/content/Context;Ljava/lang/String;I)V
    .locals 4
    ...
    iput-object v0, p0, Lbof;->e:Landroid/content/Context;

    iput-object p3, p0, Lbof;->f:Ljava/lang/String;

    iput-object p1, p0, Lbof;->d:Lbmv;

    invoke-static {}, Lcom/google/android/gms/internal/lf;->if()Lcom/google/android/gms/internal/ld;

    move-result-object v0

    iput-object v0, p0, Lbof;->h:Lcom/google/android/gms/internal/ld;

    new-instance v0, Lboh;

    iget-object v1, p0, Lbof;->e:Landroid/content/Context;

    iget-object v2, p0, Lbof;->f:Ljava/lang/String;

    invoke-direct {v0, p0, v1, v2}, Lboh;-><init>(Lbof;Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Lbof;->b:Lboh;
    ...
    iget-object v2, p0, Lbof;->e:Landroid/content/Context;

    new-instance v3, Lbog;

    invoke-direct {v3, p0}, Lbog;-><init>(Lbof;)V
...
.method private a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-virtual {v0}, Lboh;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_0
    ...
    invoke-static {p1}, Lbnl;->b(Ljava/lang/String;)V
...
.method static synthetic a(Lbof;)Lcom/google/android/gms/internal/ld;
    .locals 1

    iget-object v0, p0, Lbof;->h:Lcom/google/android/gms/internal/ld;
...
.method private a(JJ)V
    ...
    invoke-direct {p0, v0}, Lbof;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-direct {p0, p1, p2}, Lbof;->a(J)V

    goto :goto_0
.end method

.method static synthetic a(Lbof;J)V
    .locals 1
...
.method static synthetic a(Lbof;JJ)V
    .locals 1

    invoke-direct {p0, p1, p2, p3, p4}, Lbof;->a(JJ)V

    return-void
.end method

.method static synthetic b(Lbof;)Ljava/lang/String;
    .locals 1
...
.method static synthetic c(Lbof;)Landroid/content/Context;
    .locals 1

    iget-object v0, p0, Lbof;->e:Landroid/content/Context;
...
.method private f()V
    ...
    invoke-virtual {p0, v0}, Lbof;->a(I)Ljava/util/List;
    ...
    invoke-static {v1}, Lbnl;->e(Ljava/lang/String;)V
...
.method public a()V
    ...
    iget-object v0, p0, Lbof;->c:Lbmb;

    invoke-interface {v0}, Lbmb;->a()Z
    ...
    invoke-virtual {p0, v0}, Lbof;->b(I)Ljava/util/List;
    ...
    :cond_2
    iget-object v1, p0, Lbof;->c:Lbmb;

    invoke-interface {v1, v0}, Lbmb;->a(Ljava/util/List;)V

    invoke-virtual {p0}, Lbof;->d()I
...
.method public a(JLjava/lang/String;)V
    ...
    invoke-virtual {p0}, Lbof;->b()I

    invoke-direct {p0}, Lbof;->f()V

    invoke-direct {p0, p1, p2, p3}, Lbof;->b(JLjava/lang/String;)V
...
.method a([Ljava/lang/String;)V
    ...
    invoke-direct {p0, v2}, Lbof;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    :goto_1
    invoke-interface {v2, v0}, Lbmv;->a(Z)V
    :try_end_0
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method b()I
    ...
    iget-object v2, p0, Lbof;->h:Lcom/google/android/gms/internal/ld;

    invoke-interface {v2}, Lcom/google/android/gms/internal/ld;->currentTimeMillis()J

    move-result-wide v2

    iget-wide v4, p0, Lbof;->g:J
    ...
    iget-object v3, p0, Lbof;->h:Lcom/google/android/gms/internal/ld;
    ...
    :goto_1
    invoke-interface {v3, v0}, Lbmv;->a(Z)V
...
.method public b(I)Ljava/util/List;
    ...
    invoke-direct {v0, v2}, Lbof;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-direct/range {v3 .. v9}, Lbmp;-><init>(JJJ)V
    ...
    invoke-virtual {v2, v5}, Lbmp;->a(Ljava/lang/String;)V
    ...
    invoke-static {v2}, Lbnl;->b(Ljava/lang/String;)V
    :try_end_6
