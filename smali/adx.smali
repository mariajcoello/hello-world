...
# direct methods
.method constructor <init>(Lads;Ljava/util/Map;)V
    .locals 4
    ...
    iput-object v0, p0, Ladx;->b:Ljava/util/Map;
    ...
    iget-object v2, p0, Ladx;->b:Ljava/util/Map;
...
.method private b(Ljava/util/Map;)V
    ...
    invoke-static {v0}, Lads;->a(Lads;)Landroid/content/Context;

    move-result-object v0

    invoke-static {v0}, Laci;->a(Landroid/content/Context;)Ladf;

    move-result-object v0

    const-string v1, "&adid"

    invoke-static {p1, v1, v0}, Lcom/google/android/gms/analytics/an;->a(Ljava/util/Map;Ljava/lang/String;Ladf;)V
...
.method private d(Ljava/util/Map;)Z
    ...
    invoke-static {v0}, Lads;->a(Ljava/lang/String;)I
...
.method public run()V
    ...
    iget-object v0, p0, Ladx;->b:Ljava/util/Map;

    invoke-direct {p0, v0}, Ladx;->b(Ljava/util/Map;)V
    ...
    invoke-virtual {v2, v3}, Ladb;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, Ladx;->d(Ljava/util/Map;)Z
    ...
    iget-object v2, p0, Ladx;->a:Lads;

    invoke-static {v2}, Lads;->b(Lads;)Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lads;->a(Lads;Ljava/lang/String;)Ljava/lang/String;

    :cond_3
    iget-object v0, p0, Ladx;->b:Ljava/util/Map;

    invoke-direct {p0, v0}, Ladx;->c(Ljava/util/Map;)V
    ...
    iget-object v4, p0, Ladx;->b:Ljava/util/Map;

    invoke-direct {p0, v4}, Ladx;->a(Ljava/util/Map;)Ljava/lang/String;

    move-result-object v4

    iget-object v5, p0, Ladx;->a:Lads;

    invoke-static {v5}, Lads;->c(Lads;)Ljava/util/List;

    move-result-object v5

    invoke-interface/range {v0 .. v5}, Lacq;->a(Ljava/util/Map;JLjava/lang/String;Ljava/util/List;)V
