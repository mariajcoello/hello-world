...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lads;->a:Ljava/util/concurrent/LinkedBlockingQueue;

    iput-boolean v1, p0, Lads;->b:Z

    iput-boolean v1, p0, Lads;->c:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lads;->i:Ljava/util/List;
    ...
    iput-object v0, p0, Lads;->g:Landroid/content/Context;

    :goto_0
    iget-object v0, p0, Lads;->i:Ljava/util/List;
    ...
    iput-object v0, p0, Lads;->h:Ljava/util/concurrent/locks/Lock;

    invoke-virtual {p0}, Lads;->start()V

    return-void

    :cond_0
    iput-object p1, p0, Lads;->g:Landroid/content/Context;
...
.method static synthetic a(Lads;)Landroid/content/Context;
    .locals 1

    iget-object v0, p0, Lads;->g:Landroid/content/Context;

    return-object v0
.end method

.method static synthetic a(Lads;Ljava/lang/String;)Ljava/lang/String;
    .locals 0

    iput-object p1, p0, Lads;->d:Ljava/lang/String;
...
.method private a(Ljava/lang/Runnable;)V
    ...
    iget-object v0, p0, Lads;->a:Ljava/util/concurrent/LinkedBlockingQueue;
...
.method static synthetic b(Lads;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lads;->d:Ljava/lang/String;
...
.method static synthetic c(Lads;)Ljava/util/List;
    .locals 1
...
.method static synthetic d(Lads;)Lacq;
    .locals 1

    iget-object v0, p0, Lads;->f:Lacq;
...
.method public a()V
    ...
    invoke-direct {v0, p0, v1}, Ladv;-><init>(Lads;Ladt;)V

    invoke-direct {p0, v0}, Lads;->a(Ljava/lang/Runnable;)V
...
.method public a(Ljava/util/Map;)V
    ...
    invoke-direct {v0, p0, p1}, Ladx;-><init>(Lads;Ljava/util/Map;)V
...
.method public b()V
    ...
    invoke-direct {v0, p0, v1}, Ladu;-><init>(Lads;Ladt;)V
...
.method public c()V
    ...
    invoke-direct {v0, p0, v1}, Ladw;-><init>(Lads;Ladt;)V
...
.method public f()V
    ...
    iget-object v1, p0, Lads;->a:Ljava/util/concurrent/LinkedBlockingQueue;

    invoke-virtual {v1, v0}, Ljava/util/concurrent/LinkedBlockingQueue;->drainTo(Ljava/util/Collection;)I

    iget-object v1, p0, Lads;->h:Ljava/util/concurrent/locks/Lock;
    ...
    invoke-direct {p0, v0}, Lads;->a(Ljava/lang/Throwable;)Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, Lads;->h:Ljava/util/concurrent/locks/Lock;
...
.method protected declared-synchronized g()V
    ...
    iget-object v1, p0, Lads;->g:Landroid/content/Context;

    invoke-direct {v0, v1, p0}, Ladk;-><init>(Landroid/content/Context;Lacy;)V

    iput-object v0, p0, Lads;->f:Lacq;

    iget-object v0, p0, Lads;->f:Lacq;

    invoke-interface {v0}, Lacq;->d()V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public run()V
    ...
    invoke-static {v0}, Lads;->b(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lads;->d:Ljava/lang/String;
