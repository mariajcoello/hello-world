...
.field private final v:Lwl;

.field private final w:Lwk;

.field private final x:Lwj;

.field private final y:Lwh;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {v0, p0, v1}, Lwl;-><init>(Landroid/support/v7/widget/ListPopupWindow;Lwb;)V

    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->v:Lwl;

    .line 117
    new-instance v0, Lwk;

    invoke-direct {v0, p0, v1}, Lwk;-><init>(Landroid/support/v7/widget/ListPopupWindow;Lwb;)V

    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->w:Lwk;

    .line 118
    new-instance v0, Lwj;

    invoke-direct {v0, p0, v1}, Lwj;-><init>(Landroid/support/v7/widget/ListPopupWindow;Lwb;)V

    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->x:Lwj;

    .line 119
    new-instance v0, Lwh;

    invoke-direct {v0, p0, v1}, Lwh;-><init>(Landroid/support/v7/widget/ListPopupWindow;Lwb;)V

    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->y:Lwh;
...
.method public static synthetic a(Landroid/support/v7/widget/ListPopupWindow;)Lwe;
    .locals 1

    .prologue
    .line 65
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->f:Lwe;
...
.method private b()I
    ...
    invoke-direct {v0, p0}, Lwc;-><init>(Landroid/support/v7/widget/ListPopupWindow;)V
    ...
    :goto_0
    invoke-direct {v4, v5, v0}, Lwe;-><init>(Landroid/content/Context;Z)V

    iput-object v4, p0, Landroid/support/v7/widget/ListPopupWindow;->f:Lwe;
    ...
    invoke-virtual {v0, v4}, Lwe;->setSelector(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, v4}, Lwe;->setAdapter(Landroid/widget/ListAdapter;)V
    ...
    invoke-virtual {v0, v4}, Lwe;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    invoke-direct {v4, p0}, Lwd;-><init>(Landroid/support/v7/widget/ListPopupWindow;)V

    invoke-virtual {v0, v4}, Lwe;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V

    .line 1094
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->f:Lwe;

    iget-object v4, p0, Landroid/support/v7/widget/ListPopupWindow;->x:Lwj;

    invoke-virtual {v0, v4}, Lwe;->setOnScrollListener(Landroid/widget/AbsListView$OnScrollListener;)V
    ...
    invoke-virtual/range {v0 .. v5}, Lwe;->measureHeightOfChildrenCompat(IIIII)I
...
.method public static synthetic c(Landroid/support/v7/widget/ListPopupWindow;)Lwl;
    .locals 1

    .prologue
    .line 65
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->v:Lwl;
...
.method public createDragToOpenListener(Landroid/view/View;)Landroid/view/View$OnTouchListener;
    ...
    invoke-direct {v0, p0, p1}, Lwb;-><init>(Landroid/support/v7/widget/ListPopupWindow;Landroid/view/View;)V
...
.method public dismiss()V
    ...
    .line 674
    iput-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->f:Lwe;

    .line 675
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->A:Landroid/os/Handler;

    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->v:Lwl;
...
.method public getSelectedItemId()J
    ...
    invoke-virtual {v0}, Lwe;->getSelectedItemId()J
...
.method public getSelectedView()Landroid/view/View;
    ...
    invoke-virtual {v0}, Lwe;->getSelectedView()Landroid/view/View;
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    .line 892
    :cond_5
    iget-object v4, p0, Landroid/support/v7/widget/ListPopupWindow;->f:Lwe;

    invoke-virtual {v4, v2, v1}, Lwe;->lookForSelectablePosition(IZ)I
    ...
    .line 894
    :cond_6
    iget-object v3, p0, Landroid/support/v7/widget/ListPopupWindow;->f:Lwe;
    ...
    invoke-virtual {v3, v6, v2}, Lwe;->lookForSelectablePosition(IZ)I
    ...
    .line 909
    :cond_7
    iget-object v6, p0, Landroid/support/v7/widget/ListPopupWindow;->f:Lwe;

    invoke-static {v6, v2}, Lwe;->a(Lwe;Z)Z

    .line 912
    iget-object v6, p0, Landroid/support/v7/widget/ListPopupWindow;->f:Lwe;

    invoke-virtual {v6, p1, p2}, Lwe;->onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v0}, Lwe;->requestFocusFromTouch()Z
...
.method public onKeyUp(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v0, p1, p2}, Lwe;->onKeyUp(ILandroid/view/KeyEvent;)Z
...
.method public performItemClick(I)Z
    ...
    .line 781
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->f:Lwe;

    .line 782
    invoke-virtual {v1}, Lwe;->getFirstVisiblePosition()I
    ...
    .line 783
    invoke-virtual {v1}, Lwe;->getAdapter()Landroid/widget/ListAdapter;
...
.method public setAdapter(Landroid/widget/ListAdapter;)V
    ...
    invoke-direct {v0, p0, v1}, Lwi;-><init>(Landroid/support/v7/widget/ListPopupWindow;Lwb;)V
    ...
    invoke-virtual {v0, v1}, Lwe;->setAdapter(Landroid/widget/ListAdapter;)V
...
.method public show()V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->w:Lwk;
    ...
    invoke-virtual {v1, v0}, Lwe;->setSelection(I)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->y:Lwh;
