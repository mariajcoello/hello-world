...
.field private F:Landroid/support/v7/widget/ListPopupWindow$ForwardingListener;
...
.field private final L:Landroid/support/v7/internal/widget/TintManager;
...
.method constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .line 209
    iget-object v1, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->G:Lvi;
    ...
    invoke-interface {v1, v2}, Lvi;->a(Ljava/lang/CharSequence;)V
    ...
    .line 218
    iget-object v1, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->H:Lve;
    ...
    iget-object v2, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->H:Lve;

    invoke-interface {v1, v2}, Lvi;->setAdapter(Landroid/widget/ListAdapter;)V

    .line 220
    iput-object v5, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->H:Lve;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->L:Landroid/support/v7/internal/widget/TintManager;
    ...
    invoke-direct {v1, p0, v5}, Lvd;-><init>(Landroid/support/v7/internal/widget/SpinnerCompat;Lvb;)V

    iput-object v1, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->G:Lvi;
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Lvf;-><init>(Landroid/support/v7/internal/widget/SpinnerCompat;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {v1, v2}, Lvf;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-direct {v2, p0, p0, v1}, Lvb;-><init>(Landroid/support/v7/internal/widget/SpinnerCompat;Landroid/view/View;Lvf;)V

    iput-object v2, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->F:Landroid/support/v7/widget/ListPopupWindow$ForwardingListener;
...
.method public static synthetic a(Landroid/support/v7/internal/widget/SpinnerCompat;)Lvi;
    .locals 1

    .prologue
    .line 53
    iget-object v0, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->G:Lvi;
...
.method private c(IZ)Landroid/view/View;
    ...
    .line 528
    iget-object v0, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->i:Lub;

    invoke-virtual {v0, p1}, Lub;->a(I)Landroid/view/View;
...
.method a(Landroid/support/v7/internal/widget/AdapterViewCompat$OnItemClickListener;)V
    .locals 0
...
.method public a(Landroid/widget/SpinnerAdapter;)V
    ...
    invoke-direct {v1, p1}, Lve;-><init>(Landroid/widget/SpinnerAdapter;)V

    invoke-interface {v0, v1}, Lvi;->setAdapter(Landroid/widget/ListAdapter;)V
    ...
    invoke-direct {v0, p1}, Lve;-><init>(Landroid/widget/SpinnerAdapter;)V

    iput-object v0, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->H:Lve;
...
.method public getBaseline()I
    ...
    .line 384
    iget-object v2, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->i:Lub;

    invoke-virtual {v2, v3, v1}, Lub;->a(ILandroid/view/View;)V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-interface {v0}, Lvi;->dismiss()V
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-direct {v1, p0}, Lvc;-><init>(Landroid/support/v7/internal/widget/SpinnerCompat;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .prologue
    .line 421
    iget-object v0, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->F:Landroid/support/v7/widget/ListPopupWindow$ForwardingListener;
...
.method public performClick()Z
    ...
    invoke-interface {v1}, Lvi;->isShowing()Z
    ...
    invoke-interface {v1}, Lvi;->show()V
