...
.field public final b:Landroid/support/v4/media/TransportPerformer;
...
.field public final i:Landroid/view/KeyEvent$Callback;
...
.method private constructor <init>(Landroid/app/Activity;Landroid/view/View;Landroid/support/v4/media/TransportPerformer;)V
    ...
    invoke-direct {v0, p0}, Lfe;-><init>(Landroid/support/v4/media/TransportMediator;)V

    iput-object v0, p0, Landroid/support/v4/media/TransportMediator;->h:Lfg;

    .line 130
    new-instance v0, Lff;

    invoke-direct {v0, p0}, Lff;-><init>(Landroid/support/v4/media/TransportMediator;)V
    ...
    iget-object v4, p0, Landroid/support/v4/media/TransportMediator;->h:Lfg;

    invoke-direct {v0, v1, v2, v3, v4}, Lfh;-><init>(Landroid/content/Context;Landroid/media/AudioManager;Landroid/view/View;Lfg;)V

    iput-object v0, p0, Landroid/support/v4/media/TransportMediator;->f:Lfh;
...
.method private d()V
    ...
    .prologue
    .line 239
    iget-object v0, p0, Landroid/support/v4/media/TransportMediator;->f:Lfh;
    ...
    invoke-virtual {v0, v1, v2, v3, v4}, Lfh;->a(ZJI)V
