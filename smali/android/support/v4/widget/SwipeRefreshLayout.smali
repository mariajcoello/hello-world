...
.field private t:Landroid/support/v4/widget/MaterialProgressDrawable;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v0, p0}, Lrs;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V

    iput-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->E:Landroid/view/animation/Animation$AnimationListener;

    .line 842
    new-instance v0, Lrx;

    invoke-direct {v0, p0}, Lrx;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
    ...
    invoke-direct {v0, p0}, Lry;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
...
.method private a(II)Landroid/view/animation/Animation;
    ...
    invoke-direct {v1, p0, p1, p2}, Lrv;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;II)V
    ...
    .line 442
    iget-object v2, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->q:Lpa;

    invoke-virtual {v2, v0}, Lpa;->a(Landroid/view/animation/Animation$AnimationListener;)V

    .line 443
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->q:Lpa;

    invoke-virtual {v0}, Lpa;->clearAnimation()V

    .line 444
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->q:Lpa;

    invoke-virtual {v0, v1}, Lpa;->startAnimation(Landroid/view/animation/Animation;)V
...
.method private a()V
    ...
    invoke-direct {v0, v1, v3, v2}, Lpa;-><init>(Landroid/content/Context;IF)V

    iput-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->q:Lpa;
    ...
    iput-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->t:Landroid/support/v4/widget/MaterialProgressDrawable;

    .line 311
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->t:Landroid/support/v4/widget/MaterialProgressDrawable;
    ...
    iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->t:Landroid/support/v4/widget/MaterialProgressDrawable;

    invoke-virtual {v0, v1}, Lpa;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, v1}, Lpa;->setVisibility(I)V
...
.method private a(F)V
    ...
    .line 861
    iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->q:Lpa;

    invoke-virtual {v1}, Lpa;->getTop()I
...
.method private a(ILandroid/view/animation/Animation$AnimationListener;)V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->o:Landroid/view/animation/DecelerateInterpolator;
    ...
    invoke-virtual {v0, p2}, Lpa;->a(Landroid/view/animation/Animation$AnimationListener;)V
...
.method private a(IZ)V
    ...
    invoke-virtual {v0}, Lpa;->bringToFront()V

    .line 898
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->q:Lpa;

    invoke-virtual {v0, p1}, Lpa;->offsetTopAndBottom(I)V

    .line 899
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->q:Lpa;

    invoke-virtual {v0}, Lpa;->getTop()I
...
.method private a(Landroid/view/animation/Animation$AnimationListener;)V
    ...
    invoke-direct {v0, p0}, Lrt;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
    ...
    invoke-virtual {v0, p1}, Lpa;->a(Landroid/view/animation/Animation$AnimationListener;)V
...
.method private a(ZZ)V
    ...
    .line 394
    iput-boolean p2, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->A:Z
    ...
    iget-object v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->E:Landroid/view/animation/Animation$AnimationListener;
    ...
    .line 400
    :cond_1
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->E:Landroid/view/animation/Animation$AnimationListener;
...
.method public static synthetic b(Landroid/support/v4/widget/SwipeRefreshLayout;)Landroid/support/v4/widget/MaterialProgressDrawable;
    .locals 1
...
.method private b(Landroid/view/animation/Animation$AnimationListener;)V
    ...
    invoke-direct {v0, p0}, Lru;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
...
.method private c(ILandroid/view/animation/Animation$AnimationListener;)V
    ...
    iput v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->s:F

    .line 880
    :goto_0
    new-instance v0, Lrz;

    invoke-direct {v0, p0}, Lrz;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
...
.method public static synthetic d(Landroid/support/v4/widget/SwipeRefreshLayout;)Landroid/support/v4/widget/SwipeRefreshLayout$OnRefreshListener;
    .locals 1
...
.method public static synthetic e(Landroid/support/v4/widget/SwipeRefreshLayout;)Lpa;
    .locals 1
...
.method private setColorViewAlpha(I)V
    ...
    invoke-virtual {v0}, Lpa;->getBackground()Landroid/graphics/drawable/Drawable;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v2}, Lpa;->getTop()I
    ...
    .line 622
    iput v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->j:F
    ...
    .line 636
    iput-boolean v5, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->k:Z
    ...
    .line 648
    iput v4, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->l:I
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {v1}, Lpa;->getMeasuredWidth()I
    ...
    invoke-virtual {v2}, Lpa;->getMeasuredHeight()I

    move-result v2

    .line 546
    iget-object v3, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->q:Lpa;
    ...
    invoke-virtual {v3, v4, v5, v0, v1}, Lpa;->layout(IIII)V
...
.method public onMeasure(II)V
    ...
    invoke-virtual {v0, v1, v2}, Lpa;->measure(II)V
    ...
    invoke-virtual {v0}, Lpa;->getMeasuredHeight()I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 694
    sget-object v0, Landroid/support/v4/widget/SwipeRefreshLayout;->a:Ljava/lang/String;
    ...
    .line 699
    iget v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->j:F
    ...
    invoke-virtual {v2}, Lpa;->getVisibility()I
    ...
    invoke-virtual {v2, v5}, Lpa;->setVisibility(I)V

    .line 723
    :cond_6
    iget-boolean v2, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->m:Z
    ...
    .line 737
    iget-object v2, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->t:Landroid/support/v4/widget/MaterialProgressDrawable;
    ...
    iput-boolean v1, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->k:Z
    ...
    invoke-direct {v0, p0}, Lrw;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
...
.method public setProgressBackgroundColor(I)V
    ...
    invoke-virtual {v0, p1}, Lpa;->setBackgroundColor(I)V
...
.method public setProgressViewEndTarget(ZI)V
    ...
    invoke-virtual {v0}, Lpa;->invalidate()V
