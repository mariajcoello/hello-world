...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Lag;-><init>(Landroid/support/v4/app/FragmentActivity;)V
    ...
    iput-object v0, p0, Landroid/support/v4/app/FragmentActivity;->b:Lak;

    .line 106
    new-instance v0, Lah;

    invoke-direct {v0, p0}, Lah;-><init>(Landroid/support/v4/app/FragmentActivity;)V

    iput-object v0, p0, Landroid/support/v4/app/FragmentActivity;->c:Laj;
...
# virtual methods
.method a(Ljava/lang/String;ZZ)Lbe;
    .locals 2
    ...
    invoke-direct {v0, p1, p0, p2}, Lbe;-><init>(Ljava/lang/String;Landroid/support/v4/app/FragmentActivity;Z)V
    ...
    .line 873
    :cond_2
    invoke-virtual {v0, p0}, Lbe;->a(Landroid/support/v4/app/FragmentActivity;)V
...
.method a()V
    ...
    .line 778
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->m:Lbe;
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->b:Lak;
...
.method public dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, p2, p3, p4}, Lbe;->dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V

    .line 667
    :cond_1
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->b:Lak;

    invoke-virtual {v0, p1, p2, p3, p4}, Lak;->dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
...
.method public getSupportLoaderManager()Landroid/support/v4/app/LoaderManager;
    ...
    invoke-virtual {p0, v0, v1, v2}, Landroid/support/v4/app/FragmentActivity;->a(Ljava/lang/String;ZZ)Lbe;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/FragmentActivity;->m:Lbe;
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 153
    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->b:Lak;

    iget-object v1, v1, Lak;->f:Ljava/util/ArrayList;
...
.method public onBackPressed()V
    ...
    invoke-virtual {v0}, Lak;->popBackStackImmediate()Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v2, p0, Landroid/support/v4/app/FragmentActivity;->c:Laj;

    invoke-virtual {v0, p0, v2, v1}, Lak;->a(Landroid/support/v4/app/FragmentActivity;Laj;Landroid/support/v4/app/Fragment;)V
    ...
    .line 260
    iget-object v2, v0, Lai;->e:Landroid/support/v4/util/SimpleArrayMap;
    ...
    .line 264
    iget-object v3, p0, Landroid/support/v4/app/FragmentActivity;->b:Lak;

    if-eqz v0, :cond_3

    iget-object v0, v0, Lai;->d:Ljava/util/ArrayList;

    :goto_0
    invoke-virtual {v3, v2, v0}, Lak;->a(Landroid/os/Parcelable;Ljava/util/ArrayList;)V

    .line 266
    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->b:Lak;

    invoke-virtual {v0}, Lak;->g()V
...
.method public onCreatePanelMenu(ILandroid/view/Menu;)Z
    ...
    invoke-virtual {v1, p2, v2}, Lak;->a(Landroid/view/Menu;Landroid/view/MenuInflater;)Z
...
.method public onCreateView(Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    invoke-virtual {v0, p1, p2, p3}, Lak;->onCreateView(Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
...
.method public onMenuItemSelected(ILandroid/view/MenuItem;)Z
    ...
    invoke-virtual {v0, p2}, Lak;->a(Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {v0, p2}, Lak;->b(Landroid/view/MenuItem;)Z
...
.method public onPanelClosed(ILandroid/view/Menu;)V
    ...
    invoke-virtual {v0, p2}, Lak;->b(Landroid/view/Menu;)V
...
.method public onPreparePanel(ILandroid/view/View;Landroid/view/Menu;)Z
    ...
    invoke-virtual {v1, p3}, Lak;->a(Landroid/view/Menu;)Z
...
.method public final onRetainNonConfigurationInstance()Ljava/lang/Object;
    ...
    invoke-virtual {v0}, Lak;->d()Ljava/util/ArrayList;
    ...
    .line 510
    iput-object v2, v0, Lai;->a:Ljava/lang/Object;

    .line 511
    iput-object v5, v0, Lai;->b:Ljava/lang/Object;

    .line 512
    iput-object v2, v0, Lai;->c:Landroid/support/v4/util/SimpleArrayMap;

    .line 513
    iput-object v6, v0, Lai;->d:Ljava/util/ArrayList;

    .line 514
    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->l:Landroid/support/v4/util/SimpleArrayMap;

    iput-object v1, v0, Lai;->e:Landroid/support/v4/util/SimpleArrayMap;
...
.method protected onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0}, Lak;->e()Landroid/os/Parcelable;
...
.method public onStart()V
    ...
    invoke-virtual {p0, v0, v2, v1}, Landroid/support/v4/app/FragmentActivity;->a(Ljava/lang/String;ZZ)Lbe;
    ...
    .line 574
    invoke-virtual {v1}, Lbe;->d()V

    .line 575
    invoke-virtual {v1}, Lbe;->f()V
