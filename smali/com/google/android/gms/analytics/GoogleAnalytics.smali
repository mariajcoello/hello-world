...
.method protected constructor <init>(Landroid/content/Context;)V
    ...
    invoke-static {p1}, Lads;->a(Landroid/content/Context;)Lads;
    ...
    invoke-direct {p0, p1, v0, v1}, Lcom/google/android/gms/analytics/GoogleAnalytics;-><init>(Landroid/content/Context;Lacy;Lacp;)V

    return-void
.end method

.method private constructor <init>(Landroid/content/Context;Lacy;Lacp;)V
    .locals 2
    ...
    iput-object p2, p0, Lcom/google/android/gms/analytics/GoogleAnalytics;->c:Lacy;

    iput-object p3, p0, Lcom/google/android/gms/analytics/GoogleAnalytics;->d:Lacp;

    iget-object v0, p0, Lcom/google/android/gms/analytics/GoogleAnalytics;->e:Landroid/content/Context;

    invoke-static {v0}, Lacz;->a(Landroid/content/Context;)V

    iget-object v0, p0, Lcom/google/android/gms/analytics/GoogleAnalytics;->e:Landroid/content/Context;

    invoke-static {v0}, Laco;->a(Landroid/content/Context;)V

    iget-object v0, p0, Lcom/google/android/gms/analytics/GoogleAnalytics;->e:Landroid/content/Context;

    invoke-static {v0}, Ladb;->a(Landroid/content/Context;)V
...
.method public static a()Lcom/google/android/gms/analytics/GoogleAnalytics;
    .locals 2
...
.method private c()V
    ...
    invoke-direct {v1, v2}, Lady;-><init>(Landroid/content/Context;)V

    invoke-virtual {v1, v0}, Lady;->a(I)Ladd;
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/gms/analytics/GoogleAnalytics;->a(Lacj;)V
...
.method a(Lacj;)V
    ...
    invoke-virtual {p1}, Lacj;->b()Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {p1}, Lacj;->c()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p1}, Lacj;->d()Ljava/lang/String;
    ...
    :cond_1
    invoke-virtual {p1}, Lacj;->e()Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-virtual {p1}, Lacj;->f()Ljava/lang/String;
    ...
    :cond_2
    invoke-virtual {p1}, Lacj;->g()Z

    move-result v0

    if-eqz v0, :cond_3

    iget-object v0, p0, Lcom/google/android/gms/analytics/GoogleAnalytics;->d:Lacp;

    invoke-virtual {p1}, Lacj;->h()I

    move-result v1

    invoke-virtual {v0, v1}, Lacp;->a(I)V

    :cond_3
    invoke-virtual {p1}, Lacj;->i()Z

    move-result v0

    if-eqz v0, :cond_4

    invoke-virtual {p1}, Lacj;->j()Z
...
.method public a(Landroid/app/Activity;)V
    ...
    invoke-interface {v0, p1}, Lace;->a(Landroid/app/Activity;)V
...
.method a(Ljava/util/Map;)V
    ...
    invoke-static {p1, v0, v1}, Lcom/google/android/gms/analytics/an;->a(Ljava/util/Map;Ljava/lang/String;Ladf;)V
    ...
    iget-object v0, p0, Lcom/google/android/gms/analytics/GoogleAnalytics;->c:Lacy;

    invoke-interface {v0, p1}, Lacy;->a(Ljava/util/Map;)V
...
.method public b(Landroid/app/Activity;)V
    ...
    invoke-interface {v0, p1}, Lace;->b(Landroid/app/Activity;)V
...
.method public enableAutoActivityReports(Landroid/app/Application;)V
    ...
    invoke-direct {v0, p0}, Lacf;-><init>(Lcom/google/android/gms/analytics/GoogleAnalytics;)V
...
.method public newTracker(I)Lcom/google/android/gms/analytics/Tracker;
    ...
    invoke-direct {v1, v0, p0, v2}, Lcom/google/android/gms/analytics/Tracker;-><init>(Ljava/lang/String;Lach;Landroid/content/Context;)V
    ...
    invoke-direct {v0, v2}, Lacr;-><init>(Landroid/content/Context;)V

    invoke-virtual {v0, p1}, Lacr;->a(I)Ladd;
    ...
    invoke-virtual {v1, v0}, Lcom/google/android/gms/analytics/Tracker;->a(Lact;)V
...
.method public newTracker(Ljava/lang/String;)Lcom/google/android/gms/analytics/Tracker;
    ...
    invoke-direct {v0, p1, p0, v1}, Lcom/google/android/gms/analytics/Tracker;-><init>(Ljava/lang/String;Lach;Landroid/content/Context;)V
